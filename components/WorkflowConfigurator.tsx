...
export default function WorkflowConfigurator() {
  ...
  return (
    <section ref={ref} style={{
      ...
      <div className="orb-a" style={{ position: "absolute", width: 1000, height: 1000, borderRadius: "50%", background: "radial-gradient(circle, rgba(var(--blue-rgb),.055) 0%, transparent 65%)", top: "-20%", left: "55%", pointerEvents: "none" }} />
      <div className="orb-b" style={{ position: "absolute", width: 600, height: 600, borderRadius: "50%", background: "radial-gradient(circle, rgba(var(--cyan-rgb),.035) 0%, transparent 70%)", bottom: "15%", left: "2%", pointerEvents: "none" }} />

      {/* Dot grid */}
      <div style={{
        position: "absolute", inset: 0, pointerEvents: "none",
        backgroundImage: "radial-gradient(circle, rgba(var(--cyan-rgb),.065) 1px, transparent 1px)",
      ...
      <div style={{ maxWidth: 1240, margin: "0 auto", padding: "0 6%" }}>
        ...
        <div className="reveal" style={{ textAlign: "center", marginBottom: "4.5rem" }}>
          <div style={{
            ...
            <div className="pulse-dot" style={{ width: 6, height: 6, borderRadius: "50%", background: "var(--cyan)", boxShadow: "0 0 6px rgba(var(--cyan-rgb),.7)" }} />
        ...
        <div className="reveal" style={{
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: ".55rem" }}>
            <div style={{
              ...
              background: planDone ? "linear-gradient(135deg,var(--cyan),var(--blue))" : "rgba(var(--cyan-rgb),.08)",
              border: planDone ? "none" : "1px solid rgba(var(--cyan-rgb),.25)",
              display: "flex", alignItems: "center", justifyContent: "center",
              fontFamily: "var(--font-heading)", fontSize: ".88rem", fontWeight: 800,
              color: planDone ? "var(--on-accent)" : "var(--cyan)",
              transition: "all .4s ease",
              boxShadow: planDone ? "0 0 24px rgba(var(--cyan-rgb),.3)" : "none",
            }}>
              {planDone ? "✓" : "1"}
            </div>
            <span style={{ fontSize: ".7rem", fontWeight: 600, letterSpacing: ".1em", textTransform: "uppercase", color: planDone ? "var(--cyan)" : "rgba(var(--ink-rgb),.35)", transition: "color .4s" }}>
              Alap csomag
            </span>
          </div>

          {/* Connector */}
          <div style={{ width: 100, height: 2, margin: "1.35rem 1rem 0", background: "rgba(var(--ink-rgb),.06)", borderRadius: 1, position: "relative", overflow: "hidden", flexShrink: 0 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: ".55rem" }}>
            <div style={{
              width: 44, height: 44, borderRadius: "50%",
              background: wfDone ? "linear-gradient(135deg,var(--cyan),var(--blue))" : "rgba(var(--cyan-rgb),.08)",
              border: wfDone ? "none" : "1px solid rgba(var(--cyan-rgb),.25)",
              display: "flex", alignItems: "center", justifyContent: "center",
              fontFamily: "var(--font-heading)", fontSize: ".88rem", fontWeight: 800,
              color: wfDone ? "var(--on-accent)" : "var(--cyan)",
              transition: "all .4s ease",
              boxShadow: wfDone ? "0 0 24px rgba(var(--cyan-rgb),.3)" : "none",
            }}>
              {wfDone ? selectedWorkflows.size : "2"}
            </div>
            <span style={{ fontSize: ".7rem", fontWeight: 600, letterSpacing: ".1em", textTransform: "uppercase", color: wfDone ? "var(--cyan)" : "rgba(var(--ink-rgb),.35)", transition: "color .4s" }}>
              Termékek
            </span>
          </div>
        </div>
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    background: isSel
                      ? "linear-gradient(145deg, rgba(var(--cyan-rgb),.1), rgba(var(--blue-rgb),.07))"
                      : isHov ? "rgba(var(--ink-rgb),.045)" : "rgba(var(--ink-rgb),.025)",
                    border: isSel
                      ? "1px solid rgba(var(--cyan-rgb),.55)"
                      : plan.highlight ? "1px solid rgba(var(--cyan-rgb),.2)"
                      : isHov ? "1px solid rgba(var(--ink-rgb),.12)" : "1px solid rgba(var(--ink-rgb),.07)",
                    transform: isSel ? "translateY(-5px)" : isHov ? "translateY(-2px)" : "none",
                    transition: "border-color .25s ease, box-shadow .25s ease, transform .25s ease, background .25s ease",
                    boxShadow: isSel
                      ? "0 8px 40px rgba(var(--cyan-rgb),.12)"
                      : isHov ? "var(--shadow-sm)" : "none",
                  }}
                >
                  {plan.badge && (
                    <div style={{ position: "absolute", top: -13, left: "50%", transform: "translateX(-50%)", background: "linear-gradient(90deg,var(--cyan),var(--blue))", color: "var(--on-accent)", fontSize: ".6rem", fontWeight: 800, padding: ".25rem .9rem", borderRadius: 100, letterSpacing: ".1em", textTransform: "uppercase", whiteSpace: "nowrap" }}>
                      {plan.badge}
                    </div>
                  )}
                  ...
                  <div style={{
                    ...
                    background: isSel ? "var(--cyan)" : "rgba(var(--ink-rgb),.05)",
                    border: isSel ? "none" : "1px solid rgba(var(--ink-rgb),.1)",
                    display: "flex", alignItems: "center", justifyContent: "center",
                    color: isSel ? "var(--on-accent)" : "rgba(var(--ink-rgb),.15)",
                    fontSize: ".6rem", fontWeight: 900,
                    transition: "all .25s",
                    boxShadow: isSel ? "0 0 12px rgba(var(--cyan-rgb),.4)" : "none",
                  }}>
                    ✓
                  </div>
                  ...
                  <div style={{ height: 1, background: "rgba(var(--ink-rgb),.06)", marginBottom: "1.1rem" }} />
                  ...
                  <div style={{ fontSize: ".75rem", color: "var(--muted)", marginBottom: "1.1rem" }}>
                    egyszeri ·{" "}
                    <span style={{ color: isSel ? "var(--cyan)" : "rgba(var(--ink-rgb),.35)" }}>
                  ...
                  <ul style={{ listStyle: "none" }}>
                    {plan.highlights.map((h, i) => (
                      <li key={i} style={{ display: "flex", alignItems: "flex-start", gap: ".45rem", padding: ".22rem 0", fontSize: ".8rem", color: "rgba(var(--ink-rgb),.6)", lineHeight: 1.5 }}>
                  ...
                  <div style={{ marginTop: "1.1rem", fontSize: ".73rem", fontWeight: 600, color: isSel ? "rgba(var(--cyan-rgb),.65)" : "rgba(var(--ink-rgb),.18)", transition: "color .25s", letterSpacing: ".04em" }}>
        ...
        <div>
          <div className="reveal" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "1.75rem", flexWrap: "wrap", gap: "1rem" }}>
            ...
            {wfDone && (
              <span style={{ fontSize: ".78rem", fontWeight: 700, color: "var(--cyan)", background: "rgba(var(--cyan-rgb),.08)", border: "1px solid rgba(var(--cyan-rgb),.2)", borderRadius: 100, padding: ".28rem .85rem" }}>
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    border: isActive ? "1px solid rgba(var(--cyan-rgb),.45)" : "1px solid rgba(var(--ink-rgb),.1)",
                    background: isActive ? "rgba(var(--cyan-rgb),.1)" : "transparent",
                    color: isActive ? "var(--cyan)" : "rgba(var(--ink-rgb),.45)",
                    fontSize: ".8rem", fontWeight: 600, cursor: "pointer",
                    transition: "all .2s", letterSpacing: ".04em",
                  }}
                  onMouseEnter={e => { if (!isActive) { e.currentTarget.style.borderColor = "rgba(var(--ink-rgb),.2)"; e.currentTarget.style.color = "rgba(var(--ink-rgb),.75)"; }}}
                  onMouseLeave={e => { if (!isActive) { e.currentTarget.style.borderColor = "rgba(var(--ink-rgb),.1)"; e.currentTarget.style.color = "rgba(var(--ink-rgb),.45)"; }}}
                >
                  {cat}
                </button>
              );
              ...
              return (
                <article
                  ...
                  style={{
                    ...
                    background: isSel
                      ? "linear-gradient(145deg, rgba(var(--cyan-rgb),.09), rgba(var(--blue-rgb),.06))"
                      : isHov ? "rgba(var(--ink-rgb),.045)" : "rgba(var(--ink-rgb),.025)",
                    border: isSel
                      ? "1px solid rgba(var(--cyan-rgb),.5)"
                      : isHov ? "1px solid rgba(var(--ink-rgb),.13)" : "1px solid rgba(var(--ink-rgb),.07)",
                    cursor: isSoon ? "default" : "pointer",
                    opacity: isSoon ? 0.42 : 1,
                    transition: "all .22s ease",
                    boxShadow: isSel ? "0 4px 32px rgba(var(--cyan-rgb),.1)" : isHov ? "var(--shadow-sm)" : "none",
                ...
                >
                  {/* Check badge */}
                  {isSel && (
                    <div style={{ position: "absolute", top: 14, right: 14, width: 22, height: 22, borderRadius: "50%", background: "var(--cyan)", display: "flex", alignItems: "center", justifyContent: "center", color: "var(--on-accent)", fontSize: ".58rem", fontWeight: 900, boxShadow: "0 0 12px rgba(var(--cyan-rgb),.45)" }}>✓</div>
                  )}
                  {isSoon && (
                    <div style={{ position: "absolute", top: 14, right: 14, background: "rgba(var(--ink-rgb),.05)", border: "1px solid rgba(var(--ink-rgb),.1)", color: "rgba(var(--ink-rgb),.3)", fontSize: ".6rem", fontWeight: 700, padding: ".2rem .6rem", borderRadius: 100, letterSpacing: ".08em", textTransform: "uppercase" }}>
                      Hamarosan
                    </div>
                  )}
                  ...
                  <div style={{ display: "flex", flexWrap: "wrap", gap: ".35rem", marginBottom: "1rem" }}>
                    {w.tags.map((tag, j) => (
                      <span key={j} style={{ fontSize: ".7rem", fontWeight: 500, color: "var(--cyan)", background: "rgba(var(--cyan-rgb),.06)", border: "1px solid rgba(var(--cyan-rgb),.12)", borderRadius: 100, padding: ".2rem .6rem", letterSpacing: ".03em" }}>
                        {tag}
                      </span>
                    ))}
                  </div>

                  <div style={{ paddingTop: ".85rem", borderTop: "1px solid rgba(var(--ink-rgb),.05)", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                    <span style={{ fontSize: ".82rem", fontWeight: 700, color: isSel ? "var(--cyan)" : "rgba(var(--ink-rgb),.3)", transition: "color .2s" }}>
                      {w.priceLabel}
                    </span>
                    {!isSoon && (
                      <span style={{ fontSize: ".72rem", fontWeight: 600, letterSpacing: ".04em", color: isSel ? "var(--cyan)" : isHov ? "rgba(var(--ink-rgb),.5)" : "rgba(var(--ink-rgb),.18)", transition: "color .2s" }}>
      ...
      <div style={{
        ...
        {/* Top gradient border */}
        <div style={{ height: 1, background: "linear-gradient(90deg, transparent 0%, rgba(var(--cyan-rgb),.55) 30%, rgba(var(--blue-rgb),.55) 70%, transparent 100%)" }} />
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: ".55rem", flex: 1, minWidth: 0, flexWrap: "wrap" }}>
            <span style={{ fontSize: ".7rem", fontWeight: 600, color: "rgba(var(--ink-rgb),.28)", letterSpacing: ".1em", textTransform: "uppercase", whiteSpace: "nowrap" }}>
              Összeállításod:
            </span>

            {chosenPlan && (
              <div style={{ display: "inline-flex", alignItems: "center", gap: ".45rem", background: "rgba(var(--cyan-rgb),.1)", border: "1px solid rgba(var(--cyan-rgb),.3)", borderRadius: 100, padding: ".3rem .7rem .3rem .95rem", fontSize: ".82rem", fontWeight: 600, color: "var(--cyan)", whiteSpace: "nowrap" }}>
                {chosenPlan.name}
                <button
                  onClick={() => setSelectedPlan(null)}
                  style={{ background: "rgba(var(--cyan-rgb),.15)", border: "none", borderRadius: "50%", width: 18, height: 18, display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", color: "var(--cyan)", fontSize: ".6rem", flexShrink: 0, lineHeight: 1 }}
            ...
            {chosenWorkflows.map((w) => (
              <div key={w.id} style={{ display: "inline-flex", alignItems: "center", gap: ".45rem", background: "rgba(var(--ink-rgb),.06)", border: "1px solid rgba(var(--ink-rgb),.12)", borderRadius: 100, padding: ".3rem .7rem .3rem .95rem", fontSize: ".8rem", fontWeight: 600, color: "rgba(var(--ink-rgb),.7)", whiteSpace: "nowrap" }}>
                {w.title}
                <button
                  onClick={() => toggleWorkflow(w)}
                  style={{ background: "rgba(var(--ink-rgb),.1)", border: "none", borderRadius: "50%", width: 18, height: 18, display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", color: "rgba(var(--ink-rgb),.5)", fontSize: ".6rem", flexShrink: 0, lineHeight: 1 }}
          ...
          <button
            ...
            style={{
              ...
              color: "var(--on-accent)", fontFamily: "var(--font-heading)",
              fontWeight: 800, fontSize: ".9rem", letterSpacing: ".04em",
              padding: ".82rem 2.2rem", borderRadius: 10, border: "none",
              cursor: "pointer", whiteSpace: "nowrap", flexShrink: 0,
              display: "flex", alignItems: "center", gap: ".55rem",
              boxShadow: "0 0 28px rgba(var(--cyan-rgb),.25), var(--shadow-md)",
              transition: "box-shadow .25s, transform .25s",
            }}
            onMouseEnter={e => { e.currentTarget.style.boxShadow = "0 0 44px rgba(var(--cyan-rgb),.4), var(--shadow-lg)"; e.currentTarget.style.transform = "translateY(-1px)"; }}
            onMouseLeave={e => { e.currentTarget.style.boxShadow = "0 0 28px rgba(var(--cyan-rgb),.25), var(--shadow-md)"; e.currentTarget.style.transform = "none"; }}
          >
            Ajánlatot kérek
