...
export default function CTA() {
  ...
  return (
    <section id="contact" ref={ref}
      ...
      style={{ background: "var(--bg)", padding: "7rem 6% 8rem", textAlign: "center", position: "relative", overflow: "hidden" }}>

      {/* Háttér glow */}
      <div style={{ position: "absolute", inset: 0, background: "radial-gradient(ellipse 70% 55% at 50% 50%, var(--glow-pool-strong) 0%, transparent 70%)", pointerEvents: "none" }} />
      <div style={{ position: "absolute", bottom: 0, left: "50%", transform: "translateX(-50%)", width: "60%", height: 1, background: "linear-gradient(90deg, transparent, rgba(var(--cyan-rgb),.3), transparent)" }} />
      ...
      {[0, 1.5, 3].map((delay) => (
        <div key={delay} className="pulse-ring" aria-hidden="true" style={{
          ...
          border: "1px solid rgba(var(--cyan-rgb),.25)", borderRadius: "50%",
          pointerEvents: "none",
      ...
      <div className="reveal" style={{ position: "relative", zIndex: 1, maxWidth: 720, margin: "0 auto" }}>
        ...
        <p style={{ color: "rgba(var(--ink-rgb),.68)", fontSize: "1.05rem", marginBottom: "1rem", lineHeight: 1.85, maxWidth: 580, margin: "0 auto 1rem" }}>
        ...
        <p style={{ color: "rgba(var(--cyan-rgb),.7)", fontSize: ".9rem", marginBottom: "2.8rem", fontWeight: 500 }}>
        ...
        <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
          ...
          <a href="mailto:info@aiflux.hu" style={{
            ...
            border: "1px solid rgba(var(--ink-rgb),.2)", color: "rgba(var(--ink-rgb),.75)",
            ...
            onMouseLeave={e => { e.currentTarget.style.borderColor = "rgba(var(--ink-rgb),.2)"; e.currentTarget.style.color = "rgba(var(--ink-rgb),.75)"; }}>
            info@aiflux.hu
          </a>
        </div>
      </div>
