...
export default function Guarantee() {
  ...
  return (
    <section
      ...
      style={{ background: "var(--bg)", padding: "5rem 6% 6rem", position: "relative", overflow: "hidden" }}
    >
      {/* Háttér glow */}
      <div style={{ position: "absolute", inset: 0, background: "radial-gradient(ellipse 60% 50% at 50% 50%, var(--glow-pool-soft) 0%, transparent 70%)", pointerEvents: "none" }} />
      ...
      <div className="reveal" style={{ position: "relative", zIndex: 1, maxWidth: 780, margin: "0 auto" }}>
        ...
        <div style={{
          ...
          background: "linear-gradient(145deg, rgba(var(--cyan-rgb),.05), rgba(var(--blue-rgb),.04))",
          padding: "clamp(2.5rem, 6vw, 4rem) clamp(2rem, 6vw, 4rem)",
          textAlign: "center",
          boxShadow: "0 0 60px rgba(var(--cyan-rgb),.06), var(--shadow-xl)",
          position: "relative",
          overflow: "hidden",
        }}>

          {/* Sarkokban dekoratív cián vonal */}
          <div style={{ position: "absolute", top: 0, left: 0, width: 80, height: 80, borderTop: "2px solid rgba(var(--cyan-rgb),.3)", borderLeft: "2px solid rgba(var(--cyan-rgb),.3)", borderRadius: "20px 0 0 0", pointerEvents: "none" }} />
          <div style={{ position: "absolute", bottom: 0, right: 0, width: 80, height: 80, borderBottom: "2px solid rgba(var(--cyan-rgb),.3)", borderRight: "2px solid rgba(var(--cyan-rgb),.3)", borderRadius: "0 0 20px 0", pointerEvents: "none" }} />
          ...
          {/* Szöveg */}
          <p style={{ color: "rgba(var(--ink-rgb),.72)", fontSize: "1.05rem", lineHeight: 1.85, maxWidth: 580, margin: "0 auto 1.4rem" }}>
          ...
          <p style={{ color: "rgba(var(--ink-rgb),.72)", fontSize: "1.05rem", lineHeight: 1.85, maxWidth: 580, margin: "0 auto 2.4rem" }}>
            ...
            {[
              {
                ...
                icon: (
                  <svg viewBox="0 0 26 26" fill="none" stroke="url(#g1)" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" style={{ width: 24, height: 24 }}>
                    <defs><linearGradient id="g1" x1="0" y1="0" x2="1" y2="1"><stop style={{ stopColor: "var(--cyan)" }} /><stop offset="1" style={{ stopColor: "var(--blue)" }} /></linearGradient></defs>
              ...
              },
              {
                ...
                icon: (
                  <svg viewBox="0 0 26 26" fill="none" stroke="url(#g2)" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" style={{ width: 24, height: 24 }}>
                    <defs><linearGradient id="g2" x1="0" y1="0" x2="1" y2="1"><stop style={{ stopColor: "var(--cyan)" }} /><stop offset="1" style={{ stopColor: "var(--blue)" }} /></linearGradient></defs>
              ...
              },
              {
                ...
                icon: (
                  <svg viewBox="0 0 26 26" fill="none" stroke="url(#g3)" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" style={{ width: 24, height: 24 }}>
                    <defs><linearGradient id="g3" x1="0" y1="0" x2="1" y2="1"><stop style={{ stopColor: "var(--cyan)" }} /><stop offset="1" style={{ stopColor: "var(--blue)" }} /></linearGradient></defs>
          ...
          <a
            ...
            style={{
              ...
              letterSpacing: ".04em",
              fontFamily: "var(--font-heading)",
              boxShadow: "0 0 32px rgba(var(--cyan-rgb),.2)",
            }}
          >
