...
export default function Pricing() {
  ...
  return (
    ...
    >
      {/* Háttér glow */}
      <div style={{ position: "absolute", width: 800, height: 800, background: "radial-gradient(circle, rgba(var(--blue-rgb),.05) 0%, transparent 70%)", top: "50%", left: "50%", transform: "translate(-50%,-50%)", pointerEvents: "none" }} />
          ...
          <div
            ...
            style={{
              ...
              background: plan.highlight
                ? "linear-gradient(145deg, rgba(var(--cyan-rgb),.08), rgba(var(--blue-rgb),.06))"
                : "rgba(var(--ink-rgb),.03)",
              border: plan.highlight
                ? "1px solid rgba(var(--cyan-rgb),.35)"
                : hovered === plan.id
                ? "1px solid rgba(var(--cyan-rgb),.2)"
                : "1px solid rgba(var(--ink-rgb),.07)",
              transform: hovered === plan.id ? "translateY(-6px)" : "translateY(0)",
              transition: "all .3s ease",
              boxShadow: plan.highlight
                ? "0 0 40px rgba(var(--cyan-rgb),.08)"
                : hovered === plan.id
                ? "var(--shadow-md)"
                : "none",
            }}
          >
            ...
            {plan.badge && (
              <div style={{
                ...
                color: "var(--on-accent)", fontSize: ".72rem", fontWeight: 700,
            ...
            {/* Price */}
            <div style={{ marginBottom: "1.5rem", paddingBottom: "1.5rem", borderBottom: "1px solid rgba(var(--ink-rgb),.07)" }}>
              <div style={{ display: "flex", alignItems: "baseline", gap: ".3rem", marginBottom: ".4rem" }}>
                <span style={{
                  fontFamily: "var(--font-heading)",
                  fontSize: "clamp(1.6rem,3vw,2.1rem)",
                  fontWeight: 700,
                  background: plan.highlight ? "linear-gradient(90deg,var(--cyan),var(--blue))" : "var(--text)",
              ...
              <div style={{ marginTop: ".6rem", display: "flex", alignItems: "center", gap: ".4rem" }}>
                <span style={{
                  ...
                  color: plan.highlight ? "var(--cyan)" : "rgba(var(--ink-rgb),.6)",
                }}>
            ...
            <ul style={{ listStyle: "none", marginBottom: "1.8rem" }}>
              {plan.features.map((f, j) => (
                <li key={j} style={{
                  ...
                  padding: ".4rem 0",
                  borderBottom: j < plan.features.length - 1 ? "1px solid rgba(var(--ink-rgb),.04)" : "none",
                  ...
                  <span style={{
                    ...
                    fontSize: ".6rem",
                    background: f.included ? "rgba(var(--cyan-rgb),.12)" : "rgba(var(--ink-rgb),.05)",
                    border: f.included ? "1px solid rgba(var(--cyan-rgb),.3)" : "1px solid rgba(var(--ink-rgb),.1)",
                    color: f.included ? "var(--cyan)" : "rgba(var(--ink-rgb),.3)",
                  }}>
                    {f.included ? "✓" : "✕"}
                  </span>
                  <span style={{ fontSize: ".85rem", color: f.included ? "rgba(var(--ink-rgb),.85)" : "var(--muted)", lineHeight: 1.5 }}>
                    {f.text}
                  </span>
                </li>
              ))}
            ...
            <a
              ...
              style={{
                ...
                background: plan.highlight
                  ...
                  : "transparent",
                color: plan.highlight ? "var(--on-accent)" : "var(--cyan)",
                border: plan.highlight ? "none" : "1px solid rgba(var(--cyan-rgb),.3)",
                boxShadow: plan.highlight ? "0 0 24px rgba(var(--cyan-rgb),.2)" : "none",
              }}
            >
      ...
      <div className="reveal" style={{ maxWidth: 860, margin: "0 auto 3rem" }}>
        <div style={{
          ...
          background: "linear-gradient(135deg, rgba(var(--cyan-rgb),.04), rgba(var(--blue-rgb),.03))",
          ...
          <a
            ...
            onMouseEnter={e => { e.currentTarget.style.background = "rgba(var(--cyan-rgb),.08)"; e.currentTarget.style.borderColor = "rgba(var(--cyan-rgb),.6)"; }}
            onMouseLeave={e => { e.currentTarget.style.background = "transparent"; e.currentTarget.style.borderColor = "rgba(var(--cyan-rgb),.35)"; }}
          >
