...
export default function Process() {
  ...
  return (
    <section id="process" ref={ref}
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", maxWidth: 960, margin: "0 auto", position: "relative", gap: "2rem" }}>
        <div style={{ position: "absolute", top: 36, left: "calc(16.67% + 24px)", right: "calc(16.67% + 24px)", height: 1, background: "linear-gradient(90deg,var(--cyan),var(--mid),var(--blue))", zIndex: 0 }} />

        {steps.map((s, i) => (
          <div key={i} className={`reveal ${["", "delay-1", "delay-2"][i]}`}
            style={{ textAlign: "center", position: "relative", zIndex: 1 }}>

            <div style={{ width: 72, height: 72, border: "2px solid rgba(0,229,255,.25)", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 1.5rem", fontFamily: "var(--font-heading)", fontSize: "1.05rem", fontWeight: 700, color: "var(--cyan)", background: "var(--bg2)", transition: "all .35s" }}
